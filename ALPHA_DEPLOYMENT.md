...
- Portable Windows x64 build: `release/STARLADDER-0.5.0-alpha.8.0-win-x64.zip`
...
5. Restart STARLADDER from the permanent desktop shortcut. The lower-left connection tile should read **ALPHA CLOUD — Services connected**.
