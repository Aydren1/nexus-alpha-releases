# NEXUS account storage architecture
...
The verified `handle` is the player's public NEXUS name everywhere. NEXUS does not support a separate competitive callsign.
...
This table contains NEXUS preferences; it cannot override the verified RSI handle.
