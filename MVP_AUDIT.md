...
- Full-display PNG captures are stored under the user's `Pictures\\STARLADDER\\Captures` folder and associated with the active match ID when available
...
- Verified RSI handle used as the public STARLADDER name
