...
source = Path(sys.argv[1]) if len(sys.argv) > 1 else root / "design-assets" / "logo-concepts" / "starladder-orbital-sl-v1.png"
...
for size in (32, 64, 180, 192, 512):
    fitted(size).save(public / f"starladder-icon-{size}.png", optimize=True)

fitted(512).save(public / "starladder-icon-512-cyan.png", optimize=True)
fitted(1024).save(public / "starladder-logo.png", optimize=True)
fitted(512, padding=52, background=(5, 9, 15, 255)).convert("RGB").save(
    public / "starladder-icon-maskable-512.png", optimize=True
)

ico = fitted(256)
ico_sizes = [(16, 16), (24, 24), (32, 32), (48, 48), (64, 64), (128, 128), (256, 256)]
for destination in (build / "starladder.ico", public / "starladder.ico"):
    ico.save(destination, format="ICO", sizes=ico_sizes)

print(f"Generated STARLADDER logo assets from {source}")
