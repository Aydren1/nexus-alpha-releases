# NEXUS web platform plan

NEXUS should remain one React application with two delivery shells:
...
- Website: the player uses Windows, Game Bar or another capture tool, then selects the screenshots in the NEXUS match room.
