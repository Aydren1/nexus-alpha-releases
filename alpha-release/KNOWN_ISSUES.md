# STARLADDER Alpha 8.0 known issues
...
- The free alpha backend does not include automatic backups and may be paused after an extended period without activity.
- Automatic desktop updates are not enabled; install new alpha versions from the official release link.
